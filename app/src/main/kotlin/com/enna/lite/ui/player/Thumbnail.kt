...
import com.enna.lite.canvas.ArchiveTuneCanvas
import com.enna.lite.canvas.CanvasArtwork
    ...
    LaunchedEffect(itemScrollOffset) {
        ...
        if (currentItem > currentMediaIndex && canSkipNext) {
            ...
            if (com.enna.lite.ui.screens.settings.DiscordPresenceManager.isRunning()) {
                try { com.enna.lite.ui.screens.settings.DiscordPresenceManager.restart() } catch (_: Exception) {}
            }
