...
object Updater {
    ...
    private suspend fun fetchReleasesNetwork(
        ...
        val response: HttpResponse =
            client.get("https://api.github.com/repos/恩纳 (Enna)/恩纳 (Enna)/releases?per_page=$perPage") {
                headers {
                    append("Accept", "application/vnd.github+json")
                    append("User-Agent", "恩纳 (Enna)")
    ...
    suspend fun getCommitHistory(count: Int = 20, branch: String = "dev"): Result<List<GitCommit>> =
        runCatching {
            val response =
                client.get("https://api.github.com/repos/恩纳 (Enna)/恩纳 (Enna)/commits?sha=$branch&per_page=$count")
                    .bodyAsText()
    ...
    fun getLatestDownloadUrl(): String {
        val baseUrl = "https://github.com/恩纳 (Enna)/恩纳 (Enna)/releases/latest/download/"
